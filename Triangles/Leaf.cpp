...
void Leaf::initData()
{
	...
	unsigned int nInternalQuaterSteps = 7;
	
	//number of points
	dataCount = (3*(nInternalQuaterSteps*2+1) + 2)*2; 
	//number of triangles
	unsigned int nTriangles = 2*4*nInternalQuaterSteps+4*2;
	//number of indices
	indicesCount = 3*nTriangles*2;
